---
name: deck-with-delightful
description: >-
  This skill should be used when the user wants to create a slide deck presentation
  styled with the Delightful design system. Common triggers include "make a slide deck",
  "create a presentation", "build slides", "deck with delightful", "slide deck",
  "keynote-style presentation", or any request to generate a navigable slide-based
  presentation with sidebar navigation, search, keyboard controls, theme toggle,
  and neo-brutalist styling.
allowed-tools: "Bash WebFetch"
metadata:
  author: Delightful Design System
  version: 0.7.0
  tags: [design-system, css, neo-brutalist, oklch, slides, presentation, deck]
---
...
- `/Users/kylesnav/.claude/plugins/marketplaces/delightful-claude-plugin//reference/tokens.md` — All token values (colors, spacing, typography, motion)
- `/Users/kylesnav/.claude/plugins/marketplaces/delightful-claude-plugin//reference/components.md` — Component patterns with full CSS and HTML
- `/Users/kylesnav/.claude/plugins/marketplaces/delightful-claude-plugin//reference/interactions.md` — POUNCE/SINK press patterns, animation keyframes
- `/Users/kylesnav/.claude/plugins/marketplaces/delightful-claude-plugin//reference/philosophy.md` — Design principles for content tone
- `/Users/kylesnav/.claude/plugins/marketplaces/delightful-claude-plugin//reference/composition.md` — Layout composition and section assembly
...
|---|---|---|
| Scrolling page layout | Wrong format entirely — use `/present-with-delightful` | Slide-based layout with R array entries |
