---
title: "Palette Schema Specification"
date: 2026-03-02
type: spec
scope: mvp
status: active
...
| **VS Code** | Hex JSON | OKLCH-to-hex via culori with clampChroma() |
| **Obsidian** | OKLCH CSS with `--d-*` namespace | Direct from palette OKLCH values |
| **Ghostty/iTerm2** | Hex config/plist | Hand-tuned hex from `palette.terminal` |
| **Starship** | Hex TOML | Hand-tuned hex from `palette.terminal` |
