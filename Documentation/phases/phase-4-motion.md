...
- `../architecture.md` -- Section 8 (Lift/Press Interaction Pattern)
...
- **No JavaScript in this phase**: Phase 4 is CSS-only. The JS behaviors that trigger animations (splash particles, theme toggle, etc.) are documented in inline-behaviors.md but implemented during Phase 6 (showcase).
