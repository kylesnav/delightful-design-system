...
Phase 7 combines what the Rebuild Plan originally scoped as Phase 8 (Packages) and Phase 9 (Platform Distribution) into a single launch phase. The numbering is now Phases 0--7, with Phase 7 being Launch.
