...
- [ ] The three spring presets (snappy/standard/gentle) are confirmed correct by testing against the `Documentation/reference/animation-reference.html` demo
...
- [ ] 3D layer structure confirmed against `Documentation/reference/animation-reference.html`
