...
- `Documentation/future/roadmap/specs/animation-system.md` — animation system details (spring.js, flip.js, particles.js, API sketches, design decisions)
- `Documentation/phases/phase-6-showcase.md` — showcase assembly pattern
- `Documentation/reference/animation-reference.html` — the existing demo page with all physics implementations inline
