...
The complete existing spec content has been absorbed into this brief — see spec content in this document. The original spec was rated 11/11 EXCELLENT in the quality audit. This component IS present in `Documentation/reference/design-reference.html` (unlike tilt-card and spotlight).
