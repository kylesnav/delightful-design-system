...
1. `Documentation/future/roadmap/specs/animation-system.md` — the feature brief for the animation system
2. `Documentation/future/roadmap/architecture.md` — Section 2 (how items fit together) and Section 3 (what MVP must prove first)
3. `Documentation/specs/foundation/motion.md` — motion timing tokens and easing functions
4. `Documentation/specs/motion/keyframes.md` — the 22 documented keyframes
5. `Documentation/specs/motion/animation-classes.md` — animation utility classes
6. `Documentation/specs/motion/inline-behaviors.md` — Sections 8-11 (tilt card, spotlight, magnetic button, spring physics demos)
