...
- [ ] **Tilt-card rotation angle:** ±12° or ±15°? Test the `Documentation/reference/animation-reference.html` demo and confirm the intended behavior.
...
Open `Documentation/reference/animation-reference.html` and test the tilt card demo:
